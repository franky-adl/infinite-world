...
export default class Sky {
    ...
    setSphere() {
        ...
        this.sphere.update = () => {
            const geometry = new THREE.SphereGeometry(
                10,
                this.sphere.widthSegments,
                this.sphere.heightSegments,
            );
    ...
    setDebug() {
        ...
        // Sphere
        const sphereGeometryFolder = this.debug.ui.getFolder(
            "view/sky/sphere/geometry",
        );

        sphereGeometryFolder
            .add(this.sphere, "widthSegments")
            .min(4)
            .max(512)
            .step(1)
            .name("widthSegments")
        ...
        sphereGeometryFolder
            .add(this.sphere, "heightSegments")
            .min(4)
            .max(512)
            .step(1)
            .name("heightSegments")
        ...
        const sphereMaterialFolder = this.debug.ui.getFolder(
            "view/sky/sphere/material",
        );

        sphereMaterialFolder
            .add(this.sphere.material.uniforms.uAtmosphereElevation, "value")
            .min(0)
            .max(5)
            .step(0.01)
            .name("uAtmosphereElevation");
        sphereMaterialFolder
            .add(this.sphere.material.uniforms.uAtmospherePower, "value")
            .min(0)
            .max(20)
            .step(1)
            .name("uAtmospherePower");
        sphereMaterialFolder
            .addColor(this.sphere.material.uniforms.uColorDayCycleLow, "value")
            .name("uColorDayCycleLow");
        sphereMaterialFolder
            .addColor(this.sphere.material.uniforms.uColorDayCycleHigh, "value")
            .name("uColorDayCycleHigh");
        sphereMaterialFolder
            .addColor(this.sphere.material.uniforms.uColorNightLow, "value")
            .name("uColorNightLow");
        sphereMaterialFolder
            .addColor(this.sphere.material.uniforms.uColorNightHigh, "value")
            .name("uColorNightHigh");
        sphereMaterialFolder
            .add(this.sphere.material.uniforms.uDawnAngleAmplitude, "value")
            .min(0)
            .max(1)
            .step(0.001)
            .name("uDawnAngleAmplitude");
        sphereMaterialFolder
            .add(this.sphere.material.uniforms.uDawnElevationAmplitude, "value")
            .min(0)
            .max(1)
            .step(0.01)
            .name("uDawnElevationAmplitude");
        sphereMaterialFolder
            .addColor(this.sphere.material.uniforms.uColorDawn, "value")
            .name("uColorDawn");
        sphereMaterialFolder
            .add(this.sphere.material.uniforms.uSunAmplitude, "value")
            .min(0)
            .max(3)
            .step(0.01)
            .name("uSunAmplitude");
        sphereMaterialFolder
            .add(this.sphere.material.uniforms.uSunMultiplier, "value")
            .min(0)
            .max(1)
            .step(0.01)
            .name("uSunMultiplier");
        sphereMaterialFolder
            .addColor(this.sphere.material.uniforms.uColorSun, "value")
            .name("uColorSun");
    ...
    update() {
        ...
        // Sphere
        this.sphere.material.uniforms.uSunPosition.value.set(
            sunState.position.x,
            sunState.position.y,
            sunState.position.z,
        );
        this.sphere.material.uniforms.uDayCycleProgress.value =
            dayState.progress;
